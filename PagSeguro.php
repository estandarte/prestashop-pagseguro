...
class PagSeguro extends PaymentModule
{
    ...
    public function install()
    {
        ...
        Configuration::updateValue('PAGSEGURO_LIVE_MODE', false);
    ...
    {
        Configuration::deleteByName('PAGSEGURO_LIVE_MODE');
        ...
        return array(
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        'type' => 'password',
                        'name' => 'PAGSEGURO_ACCOUNT_PASSWORD',
    ...
    {
        return array(
            'PAGSEGURO_LIVE_MODE' => Configuration::get('PAGSEGURO_LIVE_MODE', true),
            'PAGSEGURO_ACCOUNT_EMAIL' => Configuration::get('PAGSEGURO_ACCOUNT_EMAIL', 'contact@prestashop.com'),
            'PAGSEGURO_ACCOUNT_PASSWORD' => Configuration::get('PAGSEGURO_ACCOUNT_PASSWORD', null),
        );
    }
